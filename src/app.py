...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice shooting, dribbling, and game strategy in a team setting",
    ...
    "Math Olympiad": {
        "description": "Solve advanced problems and prepare for mathematical competitions",
